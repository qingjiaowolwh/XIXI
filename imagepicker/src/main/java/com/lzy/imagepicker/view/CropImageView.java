...
//                    bitmap.recycle();
    ...
    private static class InnerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SAVE_SUCCESS:
                    if (mListener != null) mListener.get().onBitmapSaveSuccess(saveFile);
                    break;
                case SAVE_ERROR:
                    if (mListener != null) mListener.get().onBitmapSaveError(saveFile);
                    break;
            }
        }
    }
    ...
    /** 图片保存完成的监听 */
    private static WeakReference<OnBitmapSaveCompleteListener> mListener;
    ...
    public void setOnBitmapSaveCompleteListener(OnBitmapSaveCompleteListener listener) {
        mListener = new WeakReference<OnBitmapSaveCompleteListener>(listener);
    }
