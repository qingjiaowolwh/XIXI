...
public class MultiStateView extends FrameLayout {
    ...
    public void setContentView(@LayoutRes int layoutRes) {
        setViewForState(layoutRes,MultiStateView.VIEW_STATE_CONTENT);
    }

    public void setErrorView(@LayoutRes int layoutRes) {
        setViewForState(layoutRes,MultiStateView.VIEW_STATE_ERROR);
    }

    public void setEmptyView(@LayoutRes int layoutRes) {
        setViewForState(layoutRes,MultiStateView.VIEW_STATE_EMPTY);
    }

    public void setLoadingView(@LayoutRes int layoutRes) {
        setViewForState(layoutRes,MultiStateView.VIEW_STATE_LOADING);
    }
